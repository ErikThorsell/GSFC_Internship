...
\title{Improving Interprocess Communication in Globl/solve \\ \& \\ Improving Slew Models for IVS antennas}
\date{2016-08-18}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{frame}{Problem Description}
        ...
        % Diagram over communication between Gl and usr..
...
%%
    \begin{frame}{Results for Project One}
    %% Talk about how we do send a lot of data to make up for the larger over head.
