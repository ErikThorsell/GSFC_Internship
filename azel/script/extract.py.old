...
#                                                                             #
# $> python extractor.py skdfile logdir                                       #
#                                                                             #
# extractor.py is well suited to be run by the bash script calculate_slew.sh  #
# which runs extractor.py for all sessions present in the directories         #
